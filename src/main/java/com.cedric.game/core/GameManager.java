...
import com.cedric.game.characters.IATrainer;
...
public class GameManager {
    ...
    private void initializeNPCs() {
        ...
        Creature gymCreature1 = generateRandomCreature("gym_creature_1", "Pyroar", 15);
        Creature gymCreature2 = generateRandomCreature("gym_creature_2", "Volcania", 16);
        Creature gymCreature3 = generateRandomCreature("gym_creature_3", "Emberon", 17);
        gymLeader.addCreature(gymCreature1);
        gymLeader.addCreature(gymCreature2);
        gymLeader.addCreature(gymCreature3);
        npcs.add(gymLeader);
    }
...
import java.util.Random;
    ...
    /**
     * Suite de la classe GameManager.
     * Cette partie contient les méthodes de gestion des sauvegardes, des événements spéciaux et des PNJ.
     */
    public class GameManager {
        // Cette partie du code est la suite de la première partie
        // Les attributs et méthodes de base sont définis dans la première partie
        ...
        private boolean createTournament() {
            // Création d'un tournoi avec plusieurs dresseurs
            ...
            // Stocker les dresseurs de tournoi
        ...
        private boolean createRareCreatureEvent() {
            // Cet événement fait apparaître une créature rare à capturer
            Type[] rareTypes = {
        ...
        private boolean createSaleEvent() {
            // Cet événement réduit temporairement le prix des objets
